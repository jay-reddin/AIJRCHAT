...
var FileWatcher = class {
  ...
  createWatcher(transformWatcherId) {
    ...
    const isFreeBSD = (0, import_node_os.platform)() === "freebsd";
...
var Task = class {
  constructor(watcher, options) {
    ...
    this.filter = createFilter$1(this.watchOptions.include, this.watchOptions.exclude);
  ...
  invalidate(id, details) {
    ...
    (_b = (_a = this.watchOptions).onInvalidate) == null ? void 0 : _b.call(_a, id);
  }
  async run() {
    if (!this.invalidated)
      return;
...
rollup/dist/es/shared/watch.js:
  ...
  *)
   ...
   *)
*/
//# sourceMappingURL=watch-ZYGNHTIA.js.map
