...
var St = z(() => {
  ...
  a(v, "Socket"), _(v, "defaults", {
    ...
    fetchEndpoint: a((t, n, i) => {
      let s;
      return (i == null ? void 0 : i.jwtAuth) ? s = t.replace(ms, "apiauth.") : s = t.replace(ms, "api."), "https://" + s + "/sql";
    }, "fetchEndpoint"),
...
var As = I((At) => {
  ...
  var D = Xr(), ac = Es(), an = 1, uc = 4, vs = an + uc, _s = y.allocUnsafe(0), cn = class cn {
    constructor(e) {
      if (this.buffer = _s, this.bufferLength = 0, this.bufferOffset = 0, this.reader = new ac.BufferReader(), (e == null ? void 0 : e.mode) === "binary") throw new Error("Binary mode not supported yet");
...
function Xs(r, {
  ...
  async function de(A, g, P) {
    ...
    !Array.isArray(
      g
    ) && (g == null ? void 0 : g.authToken) !== void 0 && (Se = g.authToken);
...
var An = class An2 extends Bt.Client {
  ...
  connect(t) {
    ...
    let i = ((_a = this.config) == null ? void 0 : _a.host) !== void 0 || ((_b = this.config) == null ? void 0 : _b.connectionString) !== void 0 || m.env.PGHOST !== void 0, s = m.env.USER ?? m.env.USERNAME;
...
var Cn = class Cn2 extends Bt.Pool {
  ...
  query(t, n, i) {
    ...
    try {
      ...
      Xs(h, { fullResults: true, arrayMode: t.rowMode === "array" })(l, d, { types: t.types ?? ((_a = this.options) == null ? void 0 : _a.types) }).then((C) => i(void 0, C)).catch((C) => i(
        C
      ));
    } catch (o) {
      i(o);
