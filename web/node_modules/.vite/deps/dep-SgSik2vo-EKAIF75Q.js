...
import {
  postcss_default
} from "./chunk-JSLQQ4O2.js";
import {
  commonjsGlobal,
  getDefaultExportFromCjs,
  require_crypto
} from "./chunk-PUGQ5EYY.js";
import "./chunk-6AOBALTA.js";
import "./chunk-POFGPJ6W.js";
import "./chunk-2R27CUVF.js";
import "./chunk-MJAJF77I.js";
import "./chunk-AXLFM6V5.js";
import "./chunk-CUJJHL4M.js";
import "./chunk-FWGMBMZS.js";
import "./chunk-NJ23G3YS.js";
import {
  require_util
} from "./chunk-GOHO4ENL.js";
import {
  require_fs
...
// node_modules/vite/dist/node/chunks/dep-SgSik2vo.js
  ...
  var Container = function(_Node) {
    ...
    _proto.insertAfter = function insertAfter(oldNode, newNode) {
      ...
      for (var id3 in this.indexes) {
        index2 = this.indexes[id3];
        if (oldIndex < index2) {
          this.indexes[id3] = index2 + arguments.length - 1;
        }
      }
      return this;
    };
...
var isPureCheckDisabled = (root3) => {
  for (const node2 of root3.nodes) {
    if (node2.type !== "comment") {
      return false;
    }
    if (node2.text.trim().startsWith(IGNORE_FILE_MARKER)) {
      return true;
    }
  }
  return false;
};
function getIgnoreComment(node2) {
  if (!node2.parent) {
    return;
  }
  const indexInParent = node2.parent.index(node2);
  for (let i = indexInParent - 1; i >= 0; i--) {
    const prevNode = node2.parent.nodes[i];
  ...
  if (isAnimation) {
    ...
    const valueNodes = valueParser(declaration.value).walk((node2) => {
      if (node2.type === "div") {
        ...
        return;
      } else if (node2.type === "function" && node2.value.toLowerCase() === "local" && node2.nodes.length === 1) {
        node2.type = "word";
        node2.value = node2.nodes[0].value;
        return localizeDeclNode(node2, {
          options: context.options,
          global: context.global,
        ...
        if (node2.value.toLowerCase() === "global" && node2.nodes.length === 1) {
          node2.type = "word";
          node2.value = node2.nodes[0].value;
        }
        return false;
    ...
    prepare() {
      ...
      return {
        Once(root3) {
          ...
          const enforcePureMode = pureMode && !isPureCheckDisabled(root3);
...
function getSingleLocalNamesForComposes(root3, rule) {
  ...
  return {
    ...
    Once(root3, { rule }) {
      ...
      function localizeNode2(node2) {
        switch (node2.type) {
          case "selector":
            node2.nodes = node2.map((item) => localizeNode2(item));
            return node2;
          case "class":
      ...
      root3.walkAtRules(/scope$/i, (atRule) => {
        if (atRule.params) {
          atRule.params = atRule.params.split("to").map((item) => {
            const selector3 = item.trim().slice(1, -1).trim();
...
vite/dist/node/chunks/dep-SgSik2vo.js:
  (*! https://mths.be/cssesc v3.0.0 by @mathias *)
*/
//# sourceMappingURL=dep-SgSik2vo-EKAIF75Q.js.map
