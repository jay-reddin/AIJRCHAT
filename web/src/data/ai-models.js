...
export const modelCapabilities = {
  ...
  // OpenRouter Models Capabilities
  "openrouter:anthropic/claude-3.5-sonnet": {
    description: "Claude 3.5 Sonnet via OpenRouter - Advanced reasoning and analysis",
    maxTokens: 200000,
    functions: true,
    vision: true,
    streaming: true,
  ...
  "openrouter:openai/gpt-4o": {
    description: "GPT-4o via OpenRouter - Multimodal AI with vision capabilities",
    maxTokens: 128000,
    functions: true,
    vision: true,
    streaming: true,
    reasoning: false,
    imageGeneration: false,
    strengths: ["multimodal", "vision", "general", "coding"],
  },
  "openrouter:openai/gpt-4o-mini": {
    description: "GPT-4o Mini via OpenRouter - Fast and efficient multimodal model",
    maxTokens: 128000,
    functions: true,
    vision: true,
    streaming: true,
  ...
  "openrouter:openai/o1-preview": {
    description: "OpenAI o1 Preview via OpenRouter - Advanced reasoning model",
    maxTokens: 128000,
    functions: false,
    vision: false,
    streaming: false,
  ...
  "openrouter:openai/o1-mini": {
    description: "OpenAI o1 Mini via OpenRouter - Efficient reasoning model",
    maxTokens: 65536,
    functions: false,
    vision: false,
    streaming: false,
  ...
  "openrouter:google/gemini-2.0-flash-exp:free": {
    description: "Gemini 2.0 Flash Experimental via OpenRouter (Free)",
    maxTokens: 1000000,
    functions: true,
    vision: true,
    streaming: true,
  ...
  "openrouter:meta-llama/llama-3.3-70b-instruct:free": {
    description: "Llama 3.3 70B via OpenRouter (Free)",
    maxTokens: 128000,
    functions: true,
    vision: false,
    streaming: true,
  ...
  "openrouter:deepseek/deepseek-r1:free": {
    description: "DeepSeek R1 via OpenRouter (Free) - Advanced reasoning model",
    maxTokens: 65536,
    functions: false,
    vision: false,
    streaming: true,
  ...
  "openrouter:deepseek/deepseek-chat:free": {
    description: "DeepSeek Chat via OpenRouter (Free)",
    maxTokens: 65536,
    functions: true,
    vision: false,
    streaming: true,
    reasoning: false,
    imageGeneration: false,
    strengths: ["coding", "general", "chinese"],
  },
  "openrouter:qwen/qwen-2.5-72b-instruct:free": {
    description: "Qwen 2.5 72B via OpenRouter (Free)",
    maxTokens: 32768,
    functions: true,
    vision: false,
    streaming: true,
  ...
  "openrouter:mistralai/mistral-large": {
    description: "Mistral Large via OpenRouter - Advanced language model",
    maxTokens: 128000,
    functions: true,
    vision: false,
    streaming: true,
  ...
  "openrouter:x-ai/grok-3-beta": {
    description: "Grok 3 Beta via OpenRouter - X.AI's latest model",
    maxTokens: 128000,
    functions: true,
    vision: false,
    streaming: true,
    reasoning: true,
    imageGeneration: false,
    strengths: ["reasoning", "real-time", "humor"],
  },
  "openrouter:cohere/command-r-plus": {
    description: "Command R+ via OpenRouter - Enterprise-grade model",
    maxTokens: 128000,
    functions: true,
    vision: false,
    streaming: true,
    reasoning: false,
    imageGeneration: false,
    strengths: ["enterprise", "retrieval", "analysis"],
  },
  "openrouter:microsoft/phi-4": {
    description: "Phi-4 via OpenRouter - Microsoft's efficient model",
    maxTokens: 16384,
    functions: true,
    vision: false,
    streaming: true,
    reasoning: true,
    imageGeneration: false,
    strengths: ["efficiency", "reasoning", "coding"],
  },
};
...
export const defaultModels = [
  ...
  "deepseek-reasoner",
  "x-ai/grok-4",
  // OpenRouter Models - Now Activated
  "openrouter:anthropic/claude-3.5-sonnet",
  "openrouter:openai/gpt-4o",
  "openrouter:openai/gpt-4o-mini",
  "openrouter:openai/o1-preview",
